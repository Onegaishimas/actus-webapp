...
import { Col, Container, Row } from 'react-bootstrap'; // Updated import
      ...
      return (
        <Navigate
          to={{
            pathname: '/results',
            state: {
              url: `/form/${match.params.id}`,
              formTerms: this.state.formTerms,
              contractId: this.state.requiredFields.contractID,
              data: results
            }
          }}
        />
                                        ...
                                        <div className="input-container">
                                          ...
                                          <div className="input-wrapper">
                                            <select
                                              id={m.identifier}
                                              title={`Required Field`}
                                              value={this.state.leg1Type} // Bind to leg1Type
                                        ...
                                        <div className="input-container">
                                          ...
                                          <div className="input-wrapper">
                                            <select
                                              id={m.identifier}
                                              title={`Required Field`}
                                              value={this.state.leg2Type} // Bind to leg2Type
